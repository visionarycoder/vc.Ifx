...
public static class QueryFilterDemo
{
    public static async Task Run()
    {
        ...
        QueryFilter<User> nameContainsSmith = QueryFilterExtensions.ContainsIgnoreCase<User>(u => u.Name, "smith");
        ...
        QueryFilter<User> combined = nameContainsSmith.And(highValueOrder);
        ...
        foreach (User u in pocoMatches) Console.WriteLine($" - {u.Name} (Id={u.Id})");
        ...
        foreach (User u in efMatches) Console.WriteLine($" - {u.Name} (Id={u.Id})");
    }
}