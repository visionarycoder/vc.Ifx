...
public static class AuthenticationExtensions
{
    ...
    public static IServiceCollection AddJwtAuthentication(this IServiceCollection services, Action<JwtOptions> configureOptions)
    {
        ...
        services.AddAuthenticationProviderInfrastructure();
    ...
    private static IServiceCollection AddAuthenticationProviderInfrastructure(this IServiceCollection services)
    {
