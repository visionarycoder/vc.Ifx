...
using VisionaryCoder.Framework.Proxy.Interceptor.Security.Authentication.Abstractions;

namespace VisionaryCoder.Framework.Proxy.Interceptor.Security.Authentication;
...
public class DefaultTokenProvider : ITokenProvider
{
    ...
    public async Task<string> GetTokenAsync(CancellationToken cancellationToken = default)
    {
        ...
        TokenResult result = await GetTokenAsync(defaultRequest, cancellationToken).ConfigureAwait(false);
    ...
    public async Task<TokenResult> GetTokenAsync(TokenRequest request, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            using HttpResponseMessage response = await httpClient.SendAsync(httpRequest, timeoutCts.Token).ConfigureAwait(false);
            string responseContent = await response.Content.ReadAsStringAsync(timeoutCts.Token).ConfigureAwait(false);
    ...
    public async Task<bool> ValidateTokenAsync(string token, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            TokenValidationParameters validationParameters = await GetValidationParametersAsync(cancellationToken).ConfigureAwait(false);
