...
public class MediatorTests
{
    ...
    public async Task SendAsync_CommandWithResponse_ShouldReturnResult()
    {
        ...
        // Act
        string result = await mediator.SendAsync<TestCommandWithResponse, string>(command).ConfigureAwait(false);
    ...
    public async Task QueryAsync_Query_ShouldReturnResult()
    {
        ...
        // Act
        string result = await mediator.QueryAsync<TestQuery, string>(query).ConfigureAwait(false);
    ...
    public async Task SendAsync_NoHandlerRegistered_ShouldThrowInvalidOperationException()
    {
        ...
        // Act
        Func<Task> act = async () => await mediator.SendAsync(command).ConfigureAwait(false);

        // Assert
        await act.Should().ThrowAsync<InvalidOperationException>()
            .WithMessage("*No handler registered*").ConfigureAwait(false);
    }
